var Ball =  cc.Node.extend({
    ...
    scope           : 5000,            // 视野
    bulletSpeed     : 20,           // 子弹速度
    bulletMoveTime  : 10,            // 子弹移动到终点所需的时间
    ...
    ctor:function(fileName){
        ...
        this.schedule(this.onRotateAndFire, 2);
        this.addAttention();
    ...
    onFire : function(){
        ...
        currBullet.runAction(cc.repeatForever(cc.rotateBy(0.5,120)));
    ...
    createBullet : function(){
        var node = new cc.Sprite(res.ball_3_jpg);
        ...
        for (var i = 0; i < GameManager.currBulletPool.length; i++) {
            ...
            for (var z = 0; z < monsterArray.length; z++) {
                ...
                if (cc.rectIntersectsRect(enemyRect,bullet.getBoundingBox())) {
                    ...
                    // 怪物减血
                    enemy.blood.dropBloodAction_four();
        ...
        var LevelUp = new cc.MenuItemImage(res.Level_up,res.Level_up_down,function(){
            ...
            if(this.LevelNum<=3){
                if(this.getParent().immunity>=100){
                    ...
                    this.weapon.setTexture("res/mainScene/cell4-"+this.LevelNum+"-3.png");
                }
                else{
