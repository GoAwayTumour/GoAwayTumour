var Star =  cc.Node.extend({
    ...
    ctor:function(fileName){
        ...
        this.schedule(this.onRotateAndFire, 0.3);
        this.addAttention();
    ...
    onFire : function(){
        ...
        currBullet.runAction(cc.repeatForever(cc.rotateBy(0.5,75)));
    ...
    createBullet : function(){
        var node = new cc.Sprite(res.star_1_png);
        ...
        var LevelUp = new cc.MenuItemImage(res.Level_up,res.Level_up_down,function(){
            ...
            if(this.LevelNum<=3){
                if(this.getParent().immunity>=100){
                    ...
                    this.weapon.setTexture("res/mainScene/cell3-"+this.LevelNum+"-1.png");
                }
                else{
