 ...
 */
var TumoursevenLayer = cc.Layer.extend({
    sprite:null,
    ctor:function () {
        this._super();
        var size = cc.winSize;
        //图鉴背景图层
        var pokedexbg = new cc.Sprite(res.tumoursciencebg7);
...
var TumoursevenScene = cc.Scene.extend({
    onEnter:function () {
        this._super();
        var layer = new TumoursevenLayer();
        this.addChild(layer);
    }
});
